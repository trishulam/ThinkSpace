    ...
    <div className="agent-sidebar">
      ...
      <div className="agent-sidebar-tabs">
        ...
        >
          Gestures
          <span
            className={`agent-sidebar-tab-badge${gestureEnabled ? " active" : ""}`}
          >
        ...
        <button
          type="button"
          className={`agent-sidebar-tab${activeTab === "canvas-agent" ? " active" : ""}`}
          onClick={() => setActiveTab("canvas-agent")}
        >
          Canvas Agent
        </button>
      </div>
      ...
      {activeTab === "agent" ? (
        ...
        <div
          className="agent-sidebar-canvasTab"
          style={{
            display: "flex",
        ...
        >
          <ErrorBoundary fallback={ChatPanelFallback}>
            {app ? (
              ...
              <div style={{ padding: 16 }}>Initializing Canvas Agent...</div>
            )}
          </ErrorBoundary>
        </div>
      )}
